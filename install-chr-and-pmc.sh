...
# install chromia-cli-0.16.2-dist.tar.gz
mkdir -p /opt/chromaway/chr
wget -nv -O - https://gitlab.com/chromaway/core-tools/chromia-cli/-/package_files/117171862/download | tar -C /opt/chromaway/chr -xz
