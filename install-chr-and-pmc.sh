...
# install chromia-cli-0.17.0-dist.tar.gz
mkdir -p /opt/chromaway/chr
wget -nv -O - https://gitlab.com/chromaway/core-tools/chromia-cli/-/package_files/119177525/download | tar -C /opt/chromaway/chr -xz
