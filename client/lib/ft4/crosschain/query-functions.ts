...
import { getTransactionRid , PaginatedEntity, retrievePaginatedEntity } from "@ft4/utils";
...
export async function isTransferFullyApplied(
  ...
  return await isTransferApplied(targetConnection, initTxRid, transfer.opIndex);
}
