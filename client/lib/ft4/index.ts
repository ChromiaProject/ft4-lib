...
export {
  ...
  TransferHistoryType,
  deriveAuthDescriptorId as deriveAccountId,
  createSingleSigAuthDescriptorRegistration as createSingleSignatureAuthDescriptorRegistration,
  createMultiSigAuthDescriptorRegistration as createMultiSignatureAuthDescriptorRegistration,
  aggregateSigners,
  blockHeight,
  blockTime,
  opCount,
