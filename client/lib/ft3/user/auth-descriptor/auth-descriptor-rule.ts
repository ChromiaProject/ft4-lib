...
class RuleExpression implements AuthDescriptorRule {
    constructor(readonly name: string, readonly operator: string, readonly value: number) {}
...
class RuleCompositeExpressionOperator {
    constructor(readonly expression: RuleExpression | RuleCompositeExpression, readonly operator: string) {}
...
class RuleCompositeExpressionVariable {
    constructor(readonly expression: RuleExpression | RuleCompositeExpression, readonly name: string, readonly operator: string) {}
    ...
    private compositeExpression(operator: string, value: number): RuleCompositeExpression {
...
class RuleCompositeExpression implements AuthDescriptorRule {
    constructor(readonly operator: string, readonly left: RuleExpression | RuleCompositeExpression, readonly right: RuleExpression) {}
